...
const Section = () => {
    ...
    return (
        <>
            ...
            <div className='lg:flex md:flex lg:mx-10 xl:mx-32 2xl:mx-52  relative '>
            <div >
                    <div className='lg:hidden md:hidden block'>           
                        <img
                        src='laptop.svg' className='' />
                         <p className=' text-xl mt-[-18%]   text-center font-bold '>STREAMLINE<br />
                        YOUR<br />
                        WEALTH</p>
                        </div>
                </div>
                ...
                <div className=''>
                    <div className=''>
                        ...
                        //   variants={variantss}
                        //   transition={{ duration: 1 }}
                        src='laptop.svg' className='lg:block md:block hidden lg:mt-[-2%] xl:ml-48 2xl:ml-40 xl:mt-[-5%] absolute inset-0 lg:ml-44  w-[65%]' /></div>
                    <p className='lg:block md:block hidden text-2xl 2xl:mt-[110%] lg:mt-96 xl:mt-[100%] xl:text-3xl xl:ml-56 lg:ml-48 text-center font-bold '>STREAMLINE<br />
                        YOUR<br />
                        WEALTH</p>
                </div>
